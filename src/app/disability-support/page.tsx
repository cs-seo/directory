...
export default function DisabilitySupportIndexPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-100 max-w-3xl mx-auto mb-8">
              Connect with experienced, qualified disability support professionals across Australia. Find the right support worker for your needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/disability-support/sydney-nsw"
                className="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-purple-700 bg-white hover:bg-gray-100 transition-colors"
              >
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Comprehensive disability support services across Australia
          </p>
        </div>
      ...
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Popular Support Locations
            </h2>
            <p className="text-xl text-gray-600">
              Find disability support professionals in major Australian cities
            </p>
          </div>
          
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {[
              { name: 'Sydney, NSW', href: '/disability-support/sydney-nsw' },
              { name: 'Melbourne, VIC', href: '/disability-support/melbourne-vic' },
              { name: 'Brisbane, QLD', href: '/disability-support/brisbane-qld' },
              { name: 'Perth, WA', href: '/disability-support/perth-wa' },
              { name: 'Adelaide, SA', href: '/disability-support/adelaide-sa' },
              { name: 'Canberra, ACT', href: '/disability-support/canberra-act' },
              { name: 'Darwin, NT', href: '/disability-support/darwin-nt' },
              { name: 'Hobart, TAS', href: '/disability-support/hobart-tas' }
            ].map((location) => (
              <Link
                key={location.name}
                href={location.href}
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Our team can help you find qualified, experienced disability support professionals in your area.
          </p>
          <Link
            href="/contact"
